...
from app.storage.local import delete_chat, delete_exam, delete_graph_artifact, delete_note, load_session, save_session, write_upload
...
def _mark_session_for_rebuild(session: CourseSession) -> None:
    ...
    delete_chat(session.session_id)
