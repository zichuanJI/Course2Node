...
def tmp_storage(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(settings, "exam_llm_base_url", "https://api.deepseek.com")
    monkeypatch.setattr(settings, "exam_llm_api_key", "")
    monkeypatch.setattr(settings, "exam_llm_model", "deepseek-v4-pro")
    monkeypatch.setattr(settings, "chat_llm_base_url", "")
    monkeypatch.setattr(settings, "chat_llm_api_key", "")
    monkeypatch.setattr(settings, "chat_llm_model", "")
